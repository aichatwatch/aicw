...
`AICW` - track how AI like ChatGPT, Perplexity, Claude, and others see, discover, cite, and recommend your brand and website.
...
- Review sources by types, domains, specific links
...
AICW is runs on your computer (Mac, Windows, Linux) in a console/terminal
...
### AI Mentions Tracking - Output HTML Report 
...
## 📊 Explore More Sample AI Mentions Reports
